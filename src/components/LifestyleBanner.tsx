...
const LifestyleBanner = () => {
  ...
  return (
    <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      >
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-display uppercase tracking-wider mb-4">
          {t("lifestyle.headline")}
        </h2>
        <p className="text-foreground/60 font-body text-sm md:text-base tracking-wide mb-8">
          {t("lifestyle.sub")}
        </p>
